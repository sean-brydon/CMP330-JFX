...
public class Project {
    ...
    public static PROJECT_STATUS[] PROJECT_STATUS_ARRAY = new PROJECT_STATUS[]{PROJECT_STATUS.NEW_PROJECT, PROJECT_STATUS.IN_PROGRESS, PROJECT_STATUS.COMPLETE_PENDING_REVIEW};
